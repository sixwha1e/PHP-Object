...
class LoginModel extends Model {
  ...
  protected $_validate = array(
      array('nickname', 'require', '用户名不能为空！'), //默认情况下用正则进行验证
  ...
  protected $_auto = array (
      ...
      array('password', 'encode', 3, 'callback'), // 对password字段新增和编辑的时候回调encode函数
      array('lastip', 'get_client_ip', 1, 'function'), // 对lastip字段在登录的时候写入当前登录ip地址
      array('lastdate', 'time', 1, 'function'), // 对lastip字段在登录的时候写入当前登录ip地址
  );
