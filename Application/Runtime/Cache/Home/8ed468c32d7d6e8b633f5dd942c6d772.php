    ...
    <div class="site-wrapper">
      <div class="site-wrapper-inner">
        <div class="row">
          ...
          <div class="col-md-6">
            <button type="button" class="btn btn-default btn-lg btn-block" data-toggle="modal" data-target="#questionModal" data-title="code-100" data-content="XXXXXXXXXXXXX" data-url="http://10.10.10.10">code-100</button></br>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4">
          ...
          <div class="col-md-1"></div>
          <div class="col-md-6">
            <button type="button" class="btn btn-primary btn-lg btn-block" data-toggle="modal" data-target="#questionModal" data-title="code-200" data-content="XXXXXXXXXXXX" data-url="http://10.10.10.10">code-200</button></br>          </div>
        </div>
        <div class="row">
          <div class="col-md-4">
          ...
          <div class="col-md-1"></div>
          <div class="col-md-6">
            <button type="button" class="btn btn-default btn-lg btn-block" data-toggle="modal" data-target="#questionModal" data-title="code-300" data-content="XXXXXXXXXXXX" data-url="http://10.10.10.10">code-300</button></br>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4">
          ...
          <div class="col-md-1"></div>
          <div class="col-md-6">
            <button type="button" class="btn btn-primary btn-lg btn-block" data-toggle="modal" data-target="#questionModal" data-title="code-500" data-content="XXXXXXXXXXXX" data-url="http://10.10.10.10">code-500</button></br>
          </div>
        </div>
<!--渐变响应菜单-->
